...
public class ReceiverConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.payment.service.riskengine.config.PaymentDeserializer");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, kafkaTopic);
